...
update: function(output, domEl) {
	...
	for (var j = 0; j < journeys.length; j++) {
		...
		for (var l = 0; l < legs.length; l++) {
			var transportation = legs[l].transportation;
			var name;
			...
			switch (transportation.product.iconId) {
				case 1:
					li += "<div class=\"icon icon-1\">";
					li += '<svg id="icon-ubahn" viewBox="0 0 20 20" width="16px" height="16px">\
				...
				case 2:
					li += "<div class=\"icon icon-2\">";
					li += '<svg id="icon-sbahn" viewBox="0 0 20 20" width="16px" height="16px">\
            				<title>S-Bahn</title>\
              				<g>\
				...
				case 3:
					li += "<div class=\"icon icon-3\">";
					li += '<svg id="icon-bus" viewBox="0 0 22 20" width="16px" height="16px">\
            				<title>Bus</title>\
				...
				case 6:
					li += "<div class=\"icon icon-6\">";
					li += '<svg id="icon-rbahn" viewBox="0 0 20 20" width="16px" height="16px">\
            				<title>R-Bahn</title>\
				...
				default:
					li += "<div class=\"icon icon-x\">";
					li += '<svg id="icon-fussweg" viewBox="0 0 19 31" width="16px" height="16px">\
            				<title>Fussweg</title>\
							<g>\
